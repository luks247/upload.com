...
?>
    <div class="container" id="data">
        ...
        <?php if ($_SESSION['id'] == 1): ?>
            ...
            <div class="cards">
               <div class="card">
                    <a href="view-students.php" style="color: #ff4200"><br><br>
                        <img src="images/Sregistration.jpg" alt=""><br>
                        REGISTER STUDENT
                    </a>
                </div>
                 <div class="card">
                    <a href="viewteacher.php" style="color: #ff4200"><br><br>
                        <img src="images/Lregistration.jpg" alt=""><br>
                  REGISTER SUPERVISOR
                    </a>
                </div>
                <div class="card">
                    <a href="uploadpp.php" style="color: #ff4200"><br><br>
                        <img src="images/addproject.jpg" alt=""><br>
                      ADD PROJECT
                    </a>
                </div>
